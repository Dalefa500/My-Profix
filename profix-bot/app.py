...
8. Оптовые клиенты (стройка, магазин, бригада, «оптом», «оптовиш»,
   большой объём) — самые ценные: узнай, какой товар и примерно
   сколько нужно, и сразу предложи оставить номер — оптовые условия
   называет менеджер.
