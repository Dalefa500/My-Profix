...
- Если клиенту удобнее связаться самому — дай наш WhatsApp: {MANAGER_WHATSAPP or 'не задан'}
  Но сначала всё же предложи оставить номер: так менеджер перезвонит
  сам, и клиенту не придётся ничего делать.
