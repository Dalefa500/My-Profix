...
// Движение денег между студией и партнёром.
// Это не расходы студии в обычном смысле, поэтому они считаются отдельно.
export const FOUNDER_MOVES = [
  { id: 'draw', label: 'Взял для себя', hint: 'доля прибыли — на прибыль студии не влияет' },
  { id: 'spend', label: 'Оплатил из своих', hint: 'расход студии, и студия остаётся должна партнёру' },
  { id: 'repay', label: 'Студия вернула долг', hint: 'возврат того, что партнёр потратил за студию' },
];
